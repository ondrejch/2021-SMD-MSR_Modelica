...
%%% Step - 1; Simulation is run for 2000[s] 
%%% Step - 2; Using UHX_MODE = 2, UHX tripped at 2000[s]
%%% Step - 3; Using DHRS_MODE = 1, 4% Normal DHRS open at 2000[s]
...
DHRS_Power = P*(0.080);                                                     %Maximum power that can be removed by DHRS
Power_Bleed = P*(0);                                                    %Some power will removed from DRACS even when its not used 
