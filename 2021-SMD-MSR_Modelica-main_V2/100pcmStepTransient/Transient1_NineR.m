...
simtime = 5000;
reactdata = [0 100E-5 100E-5];
reacttime = [0 2000 simtime];
...
ts_max = 1e-2; % maximum timestep (s) *enter 'ts_max' in field 'max step size' in 'solver' pane of model configuration parameters (ctrl+E) within simulink to use this parameter
%% NEUTRONICS DATA 
...
sim('MSRE_final_9region.slx')

save('tran1R9Slink.mat','tout','powN','tIn','tOut','rho_fb_tot')