model MSRE
  ...
  SMD_MSR_Modelica.Nuclear.FuelChannel FuelChannel(
    P = 8,
    TotalFuelMass = 4.093499709644400e+03,
    hAnom = 0.0180*HTCcoefCore,
    m_FN1 = 687.3959,
    m_FN2 = 687.3959,
    m_GN = 3.6342e+03,
    cP_fuel = 1.9665E-3*CpCoefFuel,
  ...
  SMD_MSR_Modelica.HeatTransport.Pipe pipe(
    ...
    Cp_fluidPi = 1.9665E-3*CpCoefFuel,
  ...
  SMD_MSR_Modelica.HeatTransport.PrimaryPump primaryPump(
    ...
    primaryPumpK = 0.2,
    tripPrimaryPump = 200000) annotation(
  ...
  SMD_MSR_Modelica.HeatTransport.SecondaryPump secondaryPump(
    freeConvectionFF = 0.05,
    secondaryPumpK = 0.2, 
    tripSecondaryPump = 200000) annotation(
  ...
  SMD_MSR_Modelica.Nuclear.ReactivityFeedback reactivityFeedback(
    ...
    sin_mag = 0, 
    step_mag = 100E-5,
    stepInsertionTime = 2000,
    sinInsertionTime = 20000000) annotation(
