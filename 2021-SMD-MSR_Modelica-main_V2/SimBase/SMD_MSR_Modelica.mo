package SMD_MSR_Modelica
  ...
  T_PN1 = 6.635300000000000e+02;
      T_PN2 = 644.5000;
      T_PN3 = 644.4375;
      T_PN4 = 6.322200000000000e+02;
      T_TN1 = 625.1923;
      T_TN2 = 611.3643;
      T_SN1 = 562.6668;
      T_SN2 = 562.7500;
...
//maxTauPiToCore = tauPiToCore/fuelFlowFrac.FF_min;
      ...
      PiTemp_Out.T = delay(Pipe_Temp, varTauPiToCore, 50000);
      annotation(
...
//secondaryFlowFrac.FF = 1;
    ...
    model MixingPot
      ...
      input SMD_MSR_Modelica.PortsConnectors.DecayHeat_In decayHeat annotation(
        Placement(visible = true, transformation(origin = {59, -61}, extent = {{-17, -17}, {17, 17}}, rotation = 0), iconTransformation(origin = {59, -61}, extent = {{-17, -17}, {17, 17}}, rotation = 0)));
      ...
      input SMD_MSR_Modelica.PortsConnectors.Temp_In temp_In[numInput] annotation(
        Placement(visible = true, transformation(origin = {-60, -2}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-60, -2}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    ...
    equation
      ...
      annotation(
        Diagram(graphics = {Rectangle(origin = {0, -30}, extent = {{-80, 62}, {80, -62}}), Text(origin = {50, 21}, extent = {{-26, 15}, {26, -15}}, textString = "Mixing Pot"), Text(origin = {-58, -20}, extent = {{-16, 6}, {16, -6}}, textString = "TempIn"), Text(origin = {-56, -80}, extent = {{-16, 6}, {16, -6}}, textString = "FlowFrac"), Text(origin = {58, -80}, extent = {{-16, 6}, {16, -6}}, textString = "DecayHeat"), Text(origin = {62, -18}, extent = {{-16, 6}, {16, -6}}, textString = "TempOut")}),
        Icon(graphics = {Text(origin = {-56, -80}, extent = {{-16, 6}, {16, -6}}, textString = "FlowFrac"), Text(origin = {-58, -20}, extent = {{-16, 6}, {16, -6}}, textString = "TempIn"), Text(origin = {50, 21}, extent = {{-26, 15}, {26, -15}}, textString = "Mixing Pot"), Text(origin = {62, -18}, extent = {{-16, 6}, {16, -6}}, textString = "TempOut"), Text(origin = {58, -80}, extent = {{-16, 6}, {16, -6}}, textString = "DecayHeat"), Rectangle(origin = {0, -30}, extent = {{-80, 62}, {80, -62}})}));
  ...
  package Nuclear
    model mPKE
      ...
      //Variable decleration
      parameter SMD_MSR_Modelica.Units.DelayedNeutronFrac rho_0;
...
//rho_0 = CG1+CG2+CG3+CG4+CG5+CG6;
    equation
      ...
      reactivity = feedback.rho + ReactExternalSin + ReactExternalStep + rho_0;
...
//maxTauLoop = tauLoopNom/fuelFlowFrac.FF_min;
    ...
    equation
      ...
      m_FN1*cP_fuel*der(fuelNode1.T) = mdot_fuel*cP_fuel*(temp_In.T-fuelNode1.T) + kFN1*FissionPower*P - hA*(kHT_FN1/(kHT_FN1+kHT_FN2))*(fuelNode1.T - grapNode.T) + P_decay.Q*m_FN1;
      
      m_FN2*cP_fuel*der(fuelNode2.T) = mdot_fuel*cP_fuel*(fuelNode1.T-fuelNode2.T) + kFN2*FissionPower*P - hA*(kHT_FN2/(kHT_FN1+kHT_FN2))*(fuelNode1.T - grapNode.T) + P_decay.Q*m_FN2;
      ...
      annotation(
        Diagram(graphics = {Rectangle(origin = {-15.43, -10.01}, extent = {{-75.81, 90.1}, {75.81, -90.1}}), Rectangle(origin = {-40, 20}, lineColor = {20, 36, 248}, fillColor = {20, 36, 248}, fillPattern = FillPattern.Solid, extent = {{-20, 20}, {20, -20}}), Rectangle(origin = {-40, -40}, lineColor = {20, 36, 248}, fillColor = {20, 36, 248}, fillPattern = FillPattern.Solid, extent = {{-20, 20}, {20, -20}}), Rectangle(origin = {15, -10}, lineColor = {136, 138, 133}, fillColor = {136, 138, 133}, fillPattern = FillPattern.Solid, extent = {{-15, 50}, {15, -50}}), Text(origin = {10, 74}, extent = {{-47, 12}, {47, -12}}, textString = "Core Heat Transfer"), Text(origin = {-76, 35}, extent = {{-13, 13}, {13, -13}}, textString = "n(t)/n_0"), Text(origin = {-76, -20}, extent = {{-13, 13}, {13, -13}}, textString = "Decay Heat"), Text(origin = {-75, -85}, extent = {{-13, 13}, {13, -13}}, textString = "Temp_In"), Text(origin = {46, 45}, extent = {{-13, 13}, {13, -13}}, textString = "Temp_Out"), Text(origin = {47, 2}, extent = {{-13, 13}, {13, -13}}, textString = "Temp_G1"), Text(origin = {45, -54}, extent = {{-13, 13}, {13, -13}}, textString = "Temp_FN2"), Text(origin = {45, -92}, extent = {{-13, 13}, {13, -13}}, textString = "Temp_FN1")}),
    ...
    model PowerBlock
      ...
      input SMD_MSR_Modelica.PortsConnectors.NominalNeutronPopulation nPop annotation(
        Placement(visible = true, transformation(origin = {-52, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-52, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      input SMD_MSR_Modelica.PortsConnectors.DecayHeat_In P_decay annotation(
    ...
    equation
      ...
      annotation(
        Diagram(graphics = {Rectangle(origin = {-10, 10}, lineColor = {224, 27, 36}, extent = {{-70, 70}, {70, -70}}), Text(origin = {-11, 10}, extent = {{61, 46}, {-61, -46}}, textString = "Power Block")}),
        Icon(graphics = {Rectangle(origin = {-10, 10}, lineColor = {224, 27, 36}, extent = {{-70, 70}, {70, -70}}), Text(origin = {-11, 10}, extent = {{61, 46}, {-61, -46}}, textString = "Power Block")}));
    end PowerBlock;

    model SumReactivity
      parameter Integer numInput;
      input SMD_MSR_Modelica.PortsConnectors.Reactivity reactivityIn[numInput] annotation(
      ...
      output SMD_MSR_Modelica.PortsConnectors.Reactivity reactivityOut annotation(
        Placement(visible = true, transformation(origin = {-20, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-20, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      reactivityOut.rho = sum(reactivityIn.rho);
      annotation(
        Diagram(graphics = {Rectangle(origin = {0, 20}, lineColor = {51, 209, 122}, extent = {{-40, 20}, {40, -20}}), Text(origin = {11, 33}, extent = {{-29, 7}, {29, -7}}, textString = "Sum React"), Text(origin = {21, 9}, extent = {{-9, 5}, {9, -5}}, textString = "In"), Text(origin = {-19, 9}, extent = {{-9, 7}, {9, -7}}, textString = "Out")}),
        Icon(graphics = {Text(origin = {11, 33}, extent = {{-29, 7}, {29, -7}}, textString = "Sum React"), Text(origin = {21, 9}, extent = {{-9, 5}, {9, -5}}, textString = "In"), Rectangle(origin = {0, 20}, lineColor = {51, 209, 122}, extent = {{-40, 20}, {40, -20}}), Text(origin = {-19, 9}, extent = {{-9, 7}, {9, -7}}, textString = "Out")}));
    end SumReactivity;
  end Nuclear;
