...
%%Load Results 1MW
omc1R = readmatrix('U233_1R_MSRE_1MW.csv');
omc9R = readmatrix('U233_9R_MSRE_1MW.csv');
...
title('+10[pcm] step insertion @ 1[MW_t] MSRE-U233')
ylabel('\Delta Power [MW]')
legend('1R Modelica','9R Modelica')
xlim([start_plot plot_width]) 

%%Load Results 5MW
omc1R = readmatrix('U233_1R_MSRE_5MW.csv');
omc9R = readmatrix('U233_9R_MSRE_5MW.csv');
...
plot(timeOmc1R-zeroStamp,(omc1R(:,2)-powerOmc1RSS)*P,'color','#ff0000','LineWidth',2)
plot(timeOmc9R-zeroStamp,(omc9R(:,2)-powerOmc9RSS)*P,'--','color','#0000ff','LineWidth',2)
title('+10[pcm] step insertion @ 5[MW_t] MSRE-U233')
ylabel('\Delta Power [MW]')
legend('1R Modelica','9R Modelica')
xlim([start_plot plot_width])  
...
%%Load Results 8MW
omc1R = readmatrix('U233_1R_MSRE_8MW.csv');
omc9R = readmatrix('U233_9R_MSRE_8MW.csv');
...
plot(timeOmc1R-zeroStamp,(omc1R(:,2)-powerOmc1RSS)*P,'color','#ff0000','LineWidth',2)
plot(timeOmc9R-zeroStamp,(omc9R(:,2)-powerOmc9RSS)*P,'--','color','#0000ff','LineWidth',2)
title('+10[pcm] step insertion @ 8[MW_t] MSRE-U233')
ylabel('\Delta Power [MW]')
xlabel('Time [s]')
legend('1R Modelica','9R Modelica')
xlim([start_plot plot_width]) 
...
saveas(gcf,'U233Benchmark.png')
savefig('U233Benchmark.fig')