package U233stepBenchmark
   
package U233_1R
    model U233_1R_MSRE_1MW
      SMD_MSR_Modelica.Nuclear.mPKE mPKE(Lam = 4.0E-04, beta = {0.00023, 0.00079, 0.00067, 0.00073, 0.00013, 0.00009}, lam = {1.260E-02, 3.370E-02, 1.390E-01, 3.250E-01, 1.130E+00, 2.500E+00}, omega = 10, rho_0 = 0.001124143053121, sinInsertionTime = 20000000, sin_mag = 0, stepInsertionTime = 5000, step_mag = 10E-5, tauCoreNom = 8.46, tauLoopNom = 16.73) annotation(
        Placement(visible = true, transformation(origin = {-1384, 294}, extent = {{-314, -314}, {314, 314}}, rotation = 0)));
      ...
      SMD_MSR_Modelica.Nuclear.ReactivityFeedback reactivityFeedback(FuelTempSetPointNode1 = 644.5000, FuelTempSetPointNode2 = 6.57E+02, GrapTempSetPoint = 6.756111E+02, IF1 = 0.5, IF2 = 0.5, IG = 1, a_F = -11.034E-5, a_G = -5.814E-5) annotation(
    ...
    equation
      connect(mPKE.n_population, decayHeat.nPop) annotation(
        Line(points = {{-1384, 175}, {-1363, 175}, {-1363, -219}}, color = {20, 36, 248}));
      connect(mPKE.n_population, FuelChannel.nPop) annotation(
        Line(points = {{-1384, 175}, {-1040.5, 175}, {-1040.5, 171}, {-911, 171}}, color = {20, 36, 248}));
      connect(primaryPump.primaryFlowFrac, mPKE.fuelFlowFrac) annotation(
        Line(points = {{-626, -1506}, {-1078, -1506}, {-1078, 420}, {-1277, 420}}, color = {245, 121, 0}));
      ...
      connect(reactivityFeedback.feedback, mPKE.feedback) annotation(
        Line(points = {{-852, 784}, {-852, 786.5}, {-1384, 786.5}, {-1384, 420}}, color = {78, 154, 6}));
      ...
      connect(mPKE.n_population, powerBlock.nPop) annotation(
        Line(points = {{-1384, 175}, {-1634, 175}, {-1634, -124}, {-1968, -124}, {-1968, 44}}, color = {20, 36, 248}));
    ...
    end U233_1R_MSRE_1MW;
    
    model U233_1R_MSRE_5MW
      SMD_MSR_Modelica.Nuclear.mPKE mPKE(Lam = 4.0E-04, beta = {0.00023, 0.00079, 0.00067, 0.00073, 0.00013, 0.00009}, lam = {1.260E-02, 3.370E-02, 1.390E-01, 3.250E-01, 1.130E+00, 2.500E+00}, omega = 10, rho_0 = 0.001124143053121, sinInsertionTime = 20000000, sin_mag = 0, stepInsertionTime = 5000, step_mag = 10E-5, tauCoreNom = 8.46, tauLoopNom = 16.73) annotation(
    ...
    protected
      annotation(
        ...
        uses,
        __OpenModelica_simulationFlags(lv = "LOG_STATS", maxStepSize = "0.01", s = "dassl"));
    end U233_1R_MSRE_5MW;
    
    model U233_1R_MSRE_8MW
      SMD_MSR_Modelica.Nuclear.mPKE mPKE(Lam = 4.0E-04, beta = {0.00023, 0.00079, 0.00067, 0.00073, 0.00013, 0.00009}, lam = {1.260E-02, 3.370E-02, 1.390E-01, 3.250E-01, 1.130E+00, 2.500E+00}, omega = 10, rho_0 = 0.001124143053121, sinInsertionTime = 20000000, sin_mag = 0, stepInsertionTime = 5000, step_mag = 10E-5, tauCoreNom = 8.46, tauLoopNom = 16.73) annotation(
        Placement(visible = true, transformation(origin = {-1384, 288}, extent = {{-314, -314}, {314, 314}}, rotation = 0)));
      SMD_MSR_Modelica.Nuclear.DecayHeat decayHeat(P = 8, DHYG1 = 9.635981959409105E-01*2.464783802008740E-03, DHYG2 = 3.560674858154914E-02*2.464783802008740E-03, DHYG3 = 7.950554775404400E-04*2.464783802008740E-03, TotalFuelMass = 4.093499709644400e+03, DHlamG1 = 0.09453, DHlamG2 = 0.004420, DHlamG3 = 8.6098E-5) annotation(
        Placement(visible = true, transformation(origin = {-1268, -284}, extent = {{-296, -296}, {296, 296}}, rotation = 0)));
    ...
    protected
      annotation(
        ...
        uses,
        __OpenModelica_simulationFlags(lv = "LOG_STATS", maxStepSize = "0.01", s = "dassl"));
    end U233_1R_MSRE_8MW;
  end U233_1R;

  package U233_9R
    model U233_9R_MSRE_1MW
    ...
    end U233_9R_MSRE_1MW;
    
    model U233_9R_MSRE_5MW
      parameter Real CpCoefFuel = 1;
      parameter Real HTCcoefCore = 1;
      parameter Real HTCcoefPHX = 1;
      SMD_MSR_Modelica.HeatTransport.PrimaryHeatExchanger PHX(cP_Tube = 5.778E-04, cP_pFluid = 1.9665E-3*CpCoefFuel, cP_sFluid = 2.39E-3, hApnNom = 0.1620*HTCcoefPHX, hAsnNom = 0.0765, m_PN1 = 87.0959, m_PN2 = 87.0959, m_PN3 = 87.0959, m_PN4 = 87.0959, m_SN1 = 24.9200, m_SN2 = 24.9200, m_SN3 = 24.9200, m_SN4 = 24.9200, m_TN1 = 101.1662, m_TN2 = 101.1662, m_dot_pFluidNom = 7.5708E-02*2.14647E+03, m_dot_sFluidNom = 5.36265E-02*1.922E3, tauPHXtoPipe = 3.85, tauPHXtoUHX = 4.71) annotation(
    ...
    equation
      ...
      annotation(
        Diagram(coordinateSystem(extent = {{-1480, 1160}, {3040, -1780}})));
    end U233_9R_MSRE_5MW;
    
    model U233_9R_MSRE_8MW
      parameter Real CpCoefFuel = 1;
      parameter Real HTCcoefCore = 1;
      parameter Real HTCcoefPHX = 1;
      SMD_MSR_Modelica.HeatTransport.PrimaryHeatExchanger PHX(cP_Tube = 5.778E-04, cP_pFluid = 1.9665E-3*CpCoefFuel, cP_sFluid = 2.39E-3, hApnNom = 0.1620*HTCcoefPHX, hAsnNom = 0.0765, m_PN1 = 87.0959, m_PN2 = 87.0959, m_PN3 = 87.0959, m_PN4 = 87.0959, m_SN1 = 24.9200, m_SN2 = 24.9200, m_SN3 = 24.9200, m_SN4 = 24.9200, m_TN1 = 101.1662, m_TN2 = 101.1662, m_dot_pFluidNom = 7.5708E-02*2.14647E+03, m_dot_sFluidNom = 5.36265E-02*1.922E3, tauPHXtoPipe = 3.85, tauPHXtoUHX = 4.71) annotation(
    ...
    equation
      ...
      annotation(
        Diagram(coordinateSystem(extent = {{-1480, 1160}, {3040, -1780}})));
    end U233_9R_MSRE_8MW;
  end U233_9R;
end U233stepBenchmark;