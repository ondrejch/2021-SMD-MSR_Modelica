package U235stepBenchmark
   
package U235_1R
    
    model U235_1R_MSRE_1MW
      SMD_MSR_Modelica.Nuclear.mPKE mPKE(Lam = 2.400E-04, beta = {0.000223, 0.001457, 0.001307, 0.002628, 0.000766, 0.00023}, lam = {1.240E-02, 3.05E-02, 1.11E-01, 3.01E-01, 1.140E+00, 3.014E+00}, omega = 10, rho_0 = 0.002465140767843, sinInsertionTime = 20000000, sin_mag = 0, stepInsertionTime = 5000, step_mag = 10E-5, tauCoreNom = 8.46, tauLoopNom = 16.73) annotation(
        Placement(visible = true, transformation(origin = {-1396, 288}, extent = {{-314, -314}, {314, 314}}, rotation = 0)));
      ...
      SMD_MSR_Modelica.HeatTransport.DHRS dhrs(m_DHRS = 1.625049507600000e+02, Cp_fluid = 1.9665E-3, m_dotNom = 7.5708E-02*2.14647E+03, m_Pi_C_PHX = 6.126436643651999e+02, DHRS_timeConstant = 10, DHRS_MaxPowerRm = 0.04*8, DHRS_PowerBleed = 0, DHRS_time = 20000000, tauDHRStoPHX = 1.385) annotation(
      ...
      SMD_MSR_Modelica.HeatTransport.UHX uhx(SetDemand = 1/8, UHXP = 8, cP_pFluidUHX = 2.39E-3, m_PN1UHX = 3.924401289158446e+02, m_dot_pFluidUHXnom = 103.0701, tauUHXtoPHX = 8.24, tripUHX = 2000) annotation(
    ...
    equation
      connect(mPKE.n_population, decayHeat.nPop) annotation(
        Line(points = {{-1396, 169}, {-1363, 169}, {-1363, -219}}, color = {20, 36, 248}));
      connect(mPKE.n_population, FuelChannel.nPop) annotation(
        Line(points = {{-1396, 169}, {-1040.5, 169}, {-1040.5, 171}, {-911, 171}}, color = {20, 36, 248}));
      connect(primaryPump.primaryFlowFrac, mPKE.fuelFlowFrac) annotation(
        Line(points = {{-626, -1506}, {-1078, -1506}, {-1078, 414}, {-1289, 414}}, color = {245, 121, 0}));
      ...
      connect(reactivityFeedback.feedback, mPKE.feedback) annotation(
        Line(points = {{-852, 784}, {-852, 786.5}, {-1396, 786.5}, {-1396, 414}}, color = {78, 154, 6}));
      ...
      connect(mPKE.n_population, powerBlock.nPop) annotation(
        Line(points = {{-1396, 169}, {-1634, 169}, {-1634, -124}, {-1968, -124}, {-1968, 44}}, color = {20, 36, 248}));
    ...
    end U235_1R_MSRE_1MW;
    
    model U235_1R_MSRE_5MW
      SMD_MSR_Modelica.Nuclear.mPKE mPKE(Lam = 2.400E-04, beta = {0.000223, 0.001457, 0.001307, 0.002628, 0.000766, 0.00023}, lam = {1.240E-02, 3.05E-02, 1.11E-01, 3.01E-01, 1.140E+00, 3.014E+00}, omega = 10, rho_0 = 0.002465140767843, sinInsertionTime = 20000000, sin_mag = 0, stepInsertionTime = 5000, step_mag = 10E-5, tauCoreNom = 8.46, tauLoopNom = 16.73) annotation(
        Placement(visible = true, transformation(origin = {-1400, 282}, extent = {{-314, -314}, {314, 314}}, rotation = 0)));
      SMD_MSR_Modelica.Nuclear.DecayHeat decayHeat(P = 8, DHYG1 = 9.635981959409105E-01*2.464783802008740E-03, DHYG2 = 3.560674858154914E-02*2.464783802008740E-03, DHYG3 = 7.950554775404400E-04*2.464783802008740E-03, TotalFuelMass = 4.093499709644400e+03, DHlamG1 = 0.09453, DHlamG2 = 0.004420, DHlamG3 = 8.6098E-5) annotation(
        Placement(visible = true, transformation(origin = {-1268, -284}, extent = {{-296, -296}, {296, 296}}, rotation = 0)));
      SMD_MSR_Modelica.HeatTransport.PrimaryHeatExchanger PHX(m_PN1 = 87.0959, m_PN2 = 87.0959, m_PN3 = 87.0959, m_PN4 = 87.0959, m_TN1 = 101.1662, m_TN2 = 101.1662, m_SN1 = 24.9200, m_SN2 = 24.9200, m_SN3 = 24.9200, m_SN4 = 24.9200, cP_pFluid = 1.9665E-3, cP_Tube = 5.778E-04, cP_sFluid = 2.39E-3, m_dot_pFluidNom = 7.5708E-02*2.14647E+03, m_dot_sFluidNom = 5.36265E-02*1.922E3, hApnNom = 0.1620, hAsnNom = 0.0765, tauPHXtoPipe = 3.85, tauPHXtoUHX = 4.71) annotation(
        Placement(visible = true, transformation(origin = {1677, 329}, extent = {{-427, -427}, {427, 427}}, rotation = 0)));
      ...
      SMD_MSR_Modelica.Nuclear.ReactivityFeedback reactivityFeedback(FuelTempSetPointNode1 = 644.5000, FuelTempSetPointNode2 = 6.57E+02, GrapTempSetPoint = 6.756111E+02, IF1 = 0.5, IF2 = 0.5, IG = 1, a_F = -8.71E-05, a_G = -6.66E-05) annotation(
        Placement(visible = true, transformation(origin = {-762, 736}, extent = {{264, -264}, {-264, 264}}, rotation = 0)));
      SMD_MSR_Modelica.HeatTransport.UHX uhx(SetDemand = 5/8, UHXP = 8, cP_pFluidUHX = 2.39E-3, m_PN1UHX = 3.924401289158446e+02, m_dot_pFluidUHXnom = 103.0701, tauUHXtoPHX = 8.24, tripUHX = 2000) annotation(
        Placement(visible = true, transformation(origin = {2233, -477}, extent = {{-567, 567}, {567, -567}}, rotation = 0)));
      SMD_MSR_Modelica.Nuclear.PowerBlock powerBlock(P = 8, TotalFuelMass = 4.093499709644400e+03) annotation(
        Placement(visible = true, transformation(origin = {-2139, 175}, extent = {{329, -329}, {-329, 329}}, rotation = 0)));
    equation
      connect(mPKE.n_population, decayHeat.nPop) annotation(
        Line(points = {{-1400, 163}, {-1363, 163}, {-1363, -219}}, color = {20, 36, 248}));
      connect(mPKE.n_population, FuelChannel.nPop) annotation(
        Line(points = {{-1400, 163}, {-1040.5, 163}, {-1040.5, 171}, {-911, 171}}, color = {20, 36, 248}));
      connect(primaryPump.primaryFlowFrac, mPKE.fuelFlowFrac) annotation(
        Line(points = {{-626, -1506}, {-1078, -1506}, {-1078, 408}, {-1293, 408}}, color = {245, 121, 0}));
      connect(primaryPump.primaryFlowFrac, FuelChannel.fuelFlowFraction) annotation(
        Line(points = {{-626, -1506}, {-682, -1506}, {-682, -621}}, color = {245, 121, 0}));
      connect(primaryPump.primaryFlowFrac, dhrs.fuelFlowFrac) annotation(
        Line(points = {{-626, -1506}, {455, -1506}, {455, 332}}, color = {245, 121, 0}));
      connect(reactivityFeedback.feedback, mPKE.feedback) annotation(
        Line(points = {{-852, 784}, {-852, 786.5}, {-1400, 786.5}, {-1400, 408}}, color = {78, 154, 6}));
      connect(FuelChannel.grapNode, reactivityFeedback.grapNode) annotation(
        Line(points = {{-164, -70}, {-42, -70}, {-42, 656}, {-656, 656}}));
      connect(FuelChannel.fuelNode2, reactivityFeedback.fuelNode2) annotation(
        Line(points = {{-164, -334}, {90, -334}, {90, 736}, {-656, 736}}));
      ...
      connect(secondaryPump.secondaryFlowFrac, uhx.secondaryFlowFrac) annotation(
        Line(points = {{1716, -1457}, {1836, -1457}, {1836, -704}}, color = {245, 121, 0}));
      connect(mPKE.n_population, powerBlock.nPop) annotation(
        Line(points = {{-1400, 163}, {-1634, 163}, {-1634, -124}, {-1968, -124}, {-1968, 44}}, color = {20, 36, 248}));
      connect(decayHeat.decayHeat_Out, powerBlock.P_decay) annotation(
        Line(points = {{-1162, -372}, {-2244, -372}, {-2244, 44}}, color = {0, 225, 255}));
    protected
      annotation(
        ...
        uses,
        __OpenModelica_simulationFlags(lv = "LOG_STATS", maxStepSize = "0.01", s = "dassl"));
    end U235_1R_MSRE_5MW;
    
    model U235_1R_MSRE_8MW
      SMD_MSR_Modelica.Nuclear.mPKE mPKE(Lam = 2.400E-04, beta = {0.000223, 0.001457, 0.001307, 0.002628, 0.000766, 0.00023}, lam = {1.240E-02, 3.05E-02, 1.11E-01, 3.01E-01, 1.140E+00, 3.014E+00}, omega = 10, rho_0 = 0.002465140767843, sinInsertionTime = 20000000, sin_mag = 0, stepInsertionTime = 5000, step_mag = 10E-5, tauCoreNom = 8.46, tauLoopNom = 16.73) annotation(
        Placement(visible = true, transformation(origin = {-1390, 282}, extent = {{-314, -314}, {314, 314}}, rotation = 0)));
      SMD_MSR_Modelica.Nuclear.DecayHeat decayHeat(P = 8, DHYG1 = 9.635981959409105E-01*2.464783802008740E-03, DHYG2 = 3.560674858154914E-02*2.464783802008740E-03, DHYG3 = 7.950554775404400E-04*2.464783802008740E-03, TotalFuelMass = 4.093499709644400e+03, DHlamG1 = 0.09453, DHlamG2 = 0.004420, DHlamG3 = 8.6098E-5) annotation(
        Placement(visible = true, transformation(origin = {-1268, -284}, extent = {{-296, -296}, {296, 296}}, rotation = 0)));
      SMD_MSR_Modelica.HeatTransport.PrimaryHeatExchanger PHX(m_PN1 = 87.0959, m_PN2 = 87.0959, m_PN3 = 87.0959, m_PN4 = 87.0959, m_TN1 = 101.1662, m_TN2 = 101.1662, m_SN1 = 24.9200, m_SN2 = 24.9200, m_SN3 = 24.9200, m_SN4 = 24.9200, cP_pFluid = 1.9665E-3, cP_Tube = 5.778E-04, cP_sFluid = 2.39E-3, m_dot_pFluidNom = 7.5708E-02*2.14647E+03, m_dot_sFluidNom = 5.36265E-02*1.922E3, hApnNom = 0.1620, hAsnNom = 0.0765, tauPHXtoPipe = 3.85, tauPHXtoUHX = 4.71) annotation(
        Placement(visible = true, transformation(origin = {1677, 329}, extent = {{-427, -427}, {427, 427}}, rotation = 0)));
      ...
      SMD_MSR_Modelica.Nuclear.ReactivityFeedback reactivityFeedback(FuelTempSetPointNode1 = 644.5000, FuelTempSetPointNode2 = 6.57E+02, GrapTempSetPoint = 6.756111E+02, IF1 = 0.5, IF2 = 0.5, IG = 1, a_F = -8.71E-05, a_G = -6.66E-05) annotation(
        Placement(visible = true, transformation(origin = {-762, 736}, extent = {{264, -264}, {-264, 264}}, rotation = 0)));
      SMD_MSR_Modelica.HeatTransport.UHX uhx(SetDemand = 1, UHXP = 8, cP_pFluidUHX = 2.39E-3, m_PN1UHX = 3.924401289158446e+02, m_dot_pFluidUHXnom = 103.0701, tauUHXtoPHX = 8.24, tripUHX = 2000000) annotation(
        Placement(visible = true, transformation(origin = {2233, -477}, extent = {{-567, 567}, {567, -567}}, rotation = 0)));
      SMD_MSR_Modelica.Nuclear.PowerBlock powerBlock(P = 8, TotalFuelMass = 4.093499709644400e+03) annotation(
        Placement(visible = true, transformation(origin = {-2139, 175}, extent = {{329, -329}, {-329, 329}}, rotation = 0)));
    equation
      connect(mPKE.n_population, decayHeat.nPop) annotation(
        Line(points = {{-1390, 163}, {-1363, 163}, {-1363, -219}}, color = {20, 36, 248}));
      connect(mPKE.n_population, FuelChannel.nPop) annotation(
        Line(points = {{-1390, 163}, {-1040.5, 163}, {-1040.5, 171}, {-911, 171}}, color = {20, 36, 248}));
      connect(primaryPump.primaryFlowFrac, mPKE.fuelFlowFrac) annotation(
        Line(points = {{-626, -1506}, {-1078, -1506}, {-1078, 408}, {-1283, 408}}, color = {245, 121, 0}));
      connect(primaryPump.primaryFlowFrac, FuelChannel.fuelFlowFraction) annotation(
        Line(points = {{-626, -1506}, {-682, -1506}, {-682, -621}}, color = {245, 121, 0}));
      connect(primaryPump.primaryFlowFrac, dhrs.fuelFlowFrac) annotation(
        Line(points = {{-626, -1506}, {455, -1506}, {455, 332}}, color = {245, 121, 0}));
      connect(reactivityFeedback.feedback, mPKE.feedback) annotation(
        Line(points = {{-852, 784}, {-852, 786.5}, {-1390, 786.5}, {-1390, 408}}, color = {78, 154, 6}));
      connect(FuelChannel.grapNode, reactivityFeedback.grapNode) annotation(
        Line(points = {{-164, -70}, {-42, -70}, {-42, 656}, {-656, 656}}));
      connect(FuelChannel.fuelNode2, reactivityFeedback.fuelNode2) annotation(
        Line(points = {{-164, -334}, {90, -334}, {90, 736}, {-656, 736}}));
      ...
      connect(secondaryPump.secondaryFlowFrac, uhx.secondaryFlowFrac) annotation(
        Line(points = {{1716, -1457}, {1836, -1457}, {1836, -704}}, color = {245, 121, 0}));
      connect(mPKE.n_population, powerBlock.nPop) annotation(
        Line(points = {{-1390, 163}, {-1634, 163}, {-1634, -124}, {-1968, -124}, {-1968, 44}}, color = {20, 36, 248}));
      connect(decayHeat.decayHeat_Out, powerBlock.P_decay) annotation(
        Line(points = {{-1162, -372}, {-2244, -372}, {-2244, 44}}, color = {0, 225, 255}));
    protected
      annotation(
        ...
        uses,
        __OpenModelica_simulationFlags(lv = "LOG_STATS", maxStepSize = "0.01", s = "dassl"));
    end U235_1R_MSRE_8MW;
  end U235_1R;

  package U235_9R
    
    model U235_9R_MSRE_1MW
      parameter Real CpCoefFuel = 1;
      parameter Real HTCcoefCore = 1;
      parameter Real HTCcoefPHX = 1;
      SMD_MSR_Modelica.HeatTransport.PrimaryHeatExchanger PHX(cP_Tube = 5.778E-04, cP_pFluid = 1.9665E-3*CpCoefFuel, cP_sFluid = 2.39E-3, hApnNom = 0.1620*HTCcoefPHX, hAsnNom = 0.0765, m_PN1 = 87.0959, m_PN2 = 87.0959, m_PN3 = 87.0959, m_PN4 = 87.0959, m_SN1 = 24.9200, m_SN2 = 24.9200, m_SN3 = 24.9200, m_SN4 = 24.9200, m_TN1 = 101.1662, m_TN2 = 101.1662, m_dot_pFluidNom = 7.5708E-02*2.14647E+03, m_dot_sFluidNom = 5.36265E-02*1.922E3, tauPHXtoPipe = 3.85, tauPHXtoUHX = 4.71) annotation(
    ...
    equation
      ...
      connect(primaryPump.primaryFlowFrac, pipe.fuelFlowFrac) annotation(
        Line(points = {{-626, -1506}, {328, -1506}, {328, -942}, {908, -942}, {908, -800}}, color = {245, 121, 0}));
      connect(primaryPump.primaryFlowFrac, dhrs.fuelFlowFrac) annotation(
        Line(points = {{-626, -1506}, {68, -1506}, {68, 332}, {456, 332}}, color = {245, 121, 0}));
      connect(primaryPump.primaryFlowFrac, PHX.primaryFF) annotation(
        Line(points = {{-626, -1506}, {38, -1506}, {38, 1044}, {1392, 1044}, {1392, 894}}, color = {245, 121, 0}));
      connect(secondaryPump.secondaryFlowFrac, PHX.secondaryFF) annotation(
      ...
      connect(primaryPump.primaryFlowFrac, nineRcore.flowFraction_In) annotation(
        Line(points = {{-626, -1506}, {-1464, -1506}, {-1464, -326}, {-978, -326}}, color = {245, 121, 0}));
      annotation(
        Diagram(coordinateSystem(extent = {{-1480, 1160}, {3040, -1780}})));
    end U235_9R_MSRE_1MW;
    
    model U235_9R_MSRE_5MW
      parameter Real CpCoefFuel = 1;
      parameter Real HTCcoefCore = 1;
      parameter Real HTCcoefPHX = 1;
      SMD_MSR_Modelica.HeatTransport.PrimaryHeatExchanger PHX(cP_Tube = 5.778E-04, cP_pFluid = 1.9665E-3*CpCoefFuel, cP_sFluid = 2.39E-3, hApnNom = 0.1620*HTCcoefPHX, hAsnNom = 0.0765, m_PN1 = 87.0959, m_PN2 = 87.0959, m_PN3 = 87.0959, m_PN4 = 87.0959, m_SN1 = 24.9200, m_SN2 = 24.9200, m_SN3 = 24.9200, m_SN4 = 24.9200, m_TN1 = 101.1662, m_TN2 = 101.1662, m_dot_pFluidNom = 7.5708E-02*2.14647E+03, m_dot_sFluidNom = 5.36265E-02*1.922E3, tauPHXtoPipe = 3.85, tauPHXtoUHX = 4.71) annotation(
      ...
      SMD_MSR_Modelica.HeatTransport.SecondaryPump secondaryPump(freeConvectionFF = 0.05, secondaryPumpK = 0.2, tripSecondaryPump = 200000) annotation(
        Placement(visible = true, transformation(origin = {1204, -1400}, extent = {{-362, -362}, {362, 362}}, rotation = 0)));
      MSREnineR.nineRcore nineRcore(IF1 = {0.02168, 0.02197, 0.07897, 0.08249, 0.02254, 0.08255, 0.08623, 0.02745, 0.06936}, IF2 = {0.02678, 0.06519, 0.08438, 0.04124, 0.06801, 0.08823, 0.04290, 0.05529, 0.03473}, IG = {0.04443, 0.08835, 0.16671, 0.12077, 0.09181, 0.17429, 0.12612, 0.08408, 0.10343}, Lam = 2.400E-04, P = 8, TF1_0 = {641.0644, 636.1926, 662.2593, 692.4323, 634.6308, 650.7339, 669.3933, 633.4354, 638.9545}, TF2_0 = {651.9893, 647.9801, 677.5167, 699.8892, 641.9048, 660.1706, 673.9817, 635.8835, 640.4922}, TG_0 = {664.0462, 653.7083, 692.6790, 714.5485, 648.7869, 674.7077, 686.8285, 640.8657, 647.7290}, Tmix_0 = 663.5300, TotalFuelMass = 4.093499709644400e+03, aF = -8.71E-05, aG = -6.66E-05, beta = {0.000223, 0.001457, 0.001307, 0.002628, 0.000766, 0.00023}, cP_fuel = 1.9665E-3*CpCoefFuel, cP_grap = 1.773E-3, flowFracRegions = {0.0614, 0.1385, 0.2342, 0.5658}, hA = {0.0007, 0.0022, 0.0016, 0.0021, 0.0036, 0.0027, 0.0036, 0.0098, 0.0096}, kFN1 = {0.01493, 0.02736, 0.04504, 0.05126, 0.03601, 0.06014, 0.06845, 0.06179, 0.09333}, kFN2 = {0.01721, 0.04550, 0.04656, 0.04261, 0.06069, 0.06218, 0.05664, 0.07707, 0.07311}, kHT1 = {0.000946, 0.001685, 0.003029, 0.003447, 0.002216, 0.004044, 0.004603, 0.003920, 0.006277}, kHT2 = {0.001081, 0.003060, 0.003131, 0.002395, 0.004081, 0.004182, 0.003184, 0.005183, 0.004305}, lam = {1.240E-02, 3.05E-02, 1.11E-01, 3.01E-01, 1.140E+00, 3.014E+00}, mDot = 1.623879934566580e+02, mFN1 = {13.8215, 46.8650, 25.6293, 32.0366, 79.2677, 43.2952, 54.1876, 217.8490, 147.8261}, mFN2 = {14.4622, 31.9451, 25.6293, 62.4256, 54.1876, 43.2952, 105.4462, 126.6819, 248.0549}, mGN = {71.0660, 214.6193, 163.0457, 208.7310, 363.0457, 275.9391, 353.0964, 975.8376, 956.4467}, mMix = 324.7760, omega = 1, regionCoastDown = 0.02, regionFreeConvFF = 0.01, regionTripTime = {200000, 200000, 200000, 200000}, rho_0 = 0.002465140767843, sinReact = 0, sinTime = 20000000, stepReact = 10E-5, stepTime = 5000, tauCore = 8.46, tauCoreDHRS = 1.385, tauLoop = 16.73) annotation(
        Placement(visible = true, transformation(origin = {-695, -17}, extent = {{-399, -399}, {399, 399}}, rotation = 0)));
    equation
      connect(nineRcore.decayHeat_Out, dhrs.DHRS_DecayHeat) annotation(
        Line(points = {{-954, 274}, {-980, 274}, {-980, 846}, {456, 846}, {456, 570}}, color = {0, 225, 255}));
      connect(nineRcore.decayHeat_Out, pipe.PiDecay_Heat) annotation(
        Line(points = {{-954, 274}, {-938, 274}, {-938, 648}, {294, 648}, {294, -68}, {908, -68}, {908, -454}}, color = {0, 225, 255}));
      connect(nineRcore.decayHeat_Out, PHX.P_decay) annotation(
        Line(points = {{-954, 274}, {-954, 1150}, {1810, 1150}, {1810, 894}}, color = {0, 225, 255}));
      connect(pipe.PiTemp_Out, nineRcore.temp_In) annotation(
        Line(points = {{542, -618}, {-424, -618}, {-424, -312}}));
      connect(nineRcore.temp_Out, dhrs.DHRS_tempIN) annotation(
        Line(points = {{-436, 274}, {-458, 274}, {-458, 458}, {456, 458}}));
      connect(dhrs.DHRS_TempOUT, PHX.T_in_pFluid) annotation(
        Line(points = {{766, 458}, {980, 458}, {980, 810}, {1256, 810}}));
      connect(PHX.T_out_pFluid, pipe.PiTemp_IN) annotation(
        Line(points = {{2382, 810}, {2938, 810}, {2938, -720}, {1208, -720}, {1208, -618}, {908, -618}}));
      ...
      connect(secondaryPump.secondaryFlowFrac, uhx.secondaryFlowFrac) annotation(
        Line(points = {{1204, -1618}, {1764, -1618}, {1764, -458}, {2044, -458}}, color = {245, 121, 0}));
      connect(primaryPump.primaryFlowFrac, nineRcore.flowFraction_In) annotation(
        Line(points = {{-626, -1506}, {-1464, -1506}, {-1464, -320}, {-966, -320}}, color = {245, 121, 0}));
      annotation(
        Diagram(coordinateSystem(extent = {{-1480, 1160}, {3040, -1780}})));
    end U235_9R_MSRE_5MW;
    
    model U235_9R_MSRE_8MW
      parameter Real CpCoefFuel = 1;
      parameter Real HTCcoefCore = 1;
      parameter Real HTCcoefPHX = 1;
      SMD_MSR_Modelica.HeatTransport.PrimaryHeatExchanger PHX(cP_Tube = 5.778E-04, cP_pFluid = 1.9665E-3*CpCoefFuel, cP_sFluid = 2.39E-3, hApnNom = 0.1620*HTCcoefPHX, hAsnNom = 0.0765, m_PN1 = 87.0959, m_PN2 = 87.0959, m_PN3 = 87.0959, m_PN4 = 87.0959, m_SN1 = 24.9200, m_SN2 = 24.9200, m_SN3 = 24.9200, m_SN4 = 24.9200, m_TN1 = 101.1662, m_TN2 = 101.1662, m_dot_pFluidNom = 7.5708E-02*2.14647E+03, m_dot_sFluidNom = 5.36265E-02*1.922E3, tauPHXtoPipe = 3.85, tauPHXtoUHX = 4.71) annotation(
      ...
      SMD_MSR_Modelica.HeatTransport.PrimaryPump primaryPump(freeConvectionFF = 0.05, primaryPumpK = 0.2, tripPrimaryPump = 2000000) annotation(
        Placement(visible = true, transformation(origin = {-626, -1274}, extent = {{-386, -386}, {386, 386}}, rotation = 0)));
      SMD_MSR_Modelica.HeatTransport.Pipe pipe(Cp_fluidPi = 1.9665E-3*CpCoefFuel, m_Pi_PHX_C = 1.408917923089200e+03, m_dotPiNom = 7.5708E-02*2.14647E+03, m_pi = 1.625049507600000e+02, tauPiToCore = 3.835) annotation(
        Placement(visible = true, transformation(origin = {677, -737}, extent = {{481, -481}, {-481, 481}}, rotation = 0)));
      SMD_MSR_Modelica.HeatTransport.UHX uhx(SetDemand = 8, UHXP = 8, cP_pFluidUHX = 2.39E-3, m_PN1UHX = 3.924401289158446e+02, m_dot_pFluidUHXnom = 103.0701, tauUHXtoPHX = 8.24, tripUHX = 2000000) annotation(
        Placement(visible = true, transformation(origin = {2441, -231}, extent = {{-567, 567}, {567, -567}}, rotation = 0)));
      SMD_MSR_Modelica.HeatTransport.DHRS dhrs(Cp_fluid = 1.9665E-3*CpCoefFuel, DHRS_MaxPowerRm = 0.04*8, DHRS_PowerBleed = 0, DHRS_time = 20000000, DHRS_timeConstant = 10, m_DHRS = 1.625049507600000e+02, m_Pi_C_PHX = 6.126436643651999e+02, m_dotNom = 7.5708E-02*2.14647E+03, tauDHRStoPHX = 1.385) annotation(
        Placement(visible = true, transformation(origin = {634, 392}, extent = {{-298, -298}, {298, 298}}, rotation = 0)));
      SMD_MSR_Modelica.HeatTransport.SecondaryPump secondaryPump(freeConvectionFF = 0.05, secondaryPumpK = 0.2, tripSecondaryPump = 200000) annotation(
        Placement(visible = true, transformation(origin = {1204, -1400}, extent = {{-362, -362}, {362, 362}}, rotation = 0)));
      MSREnineR.nineRcore nineRcore(IF1 = {0.02168, 0.02197, 0.07897, 0.08249, 0.02254, 0.08255, 0.08623, 0.02745, 0.06936}, IF2 = {0.02678, 0.06519, 0.08438, 0.04124, 0.06801, 0.08823, 0.04290, 0.05529, 0.03473}, IG = {0.04443, 0.08835, 0.16671, 0.12077, 0.09181, 0.17429, 0.12612, 0.08408, 0.10343}, Lam = 2.400E-04, P = 8, TF1_0 = {641.0644, 636.1926, 662.2593, 692.4323, 634.6308, 650.7339, 669.3933, 633.4354, 638.9545}, TF2_0 = {651.9893, 647.9801, 677.5167, 699.8892, 641.9048, 660.1706, 673.9817, 635.8835, 640.4922}, TG_0 = {664.0462, 653.7083, 692.6790, 714.5485, 648.7869, 674.7077, 686.8285, 640.8657, 647.7290}, Tmix_0 = 663.5300, TotalFuelMass = 4.093499709644400e+03, aF = -8.71E-05, aG = -6.66E-05, beta = {0.000223, 0.001457, 0.001307, 0.002628, 0.000766, 0.00023}, cP_fuel = 1.9665E-3*CpCoefFuel, cP_grap = 1.773E-3, flowFracRegions = {0.0614, 0.1385, 0.2342, 0.5658}, hA = {0.0007, 0.0022, 0.0016, 0.0021, 0.0036, 0.0027, 0.0036, 0.0098, 0.0096}, kFN1 = {0.01493, 0.02736, 0.04504, 0.05126, 0.03601, 0.06014, 0.06845, 0.06179, 0.09333}, kFN2 = {0.01721, 0.04550, 0.04656, 0.04261, 0.06069, 0.06218, 0.05664, 0.07707, 0.07311}, kHT1 = {0.000946, 0.001685, 0.003029, 0.003447, 0.002216, 0.004044, 0.004603, 0.003920, 0.006277}, kHT2 = {0.001081, 0.003060, 0.003131, 0.002395, 0.004081, 0.004182, 0.003184, 0.005183, 0.004305}, lam = {1.240E-02, 3.05E-02, 1.11E-01, 3.01E-01, 1.140E+00, 3.014E+00}, mDot = 1.623879934566580e+02, mFN1 = {13.8215, 46.8650, 25.6293, 32.0366, 79.2677, 43.2952, 54.1876, 217.8490, 147.8261}, mFN2 = {14.4622, 31.9451, 25.6293, 62.4256, 54.1876, 43.2952, 105.4462, 126.6819, 248.0549}, mGN = {71.0660, 214.6193, 163.0457, 208.7310, 363.0457, 275.9391, 353.0964, 975.8376, 956.4467}, mMix = 324.7760, omega = 1, regionCoastDown = 0.02, regionFreeConvFF = 0.01, regionTripTime = {200000, 200000, 200000, 200000}, rho_0 = 0.002465140767843, sinReact = 0, sinTime = 20000000, stepReact = 10E-5, stepTime = 5000, tauCore = 8.46, tauCoreDHRS = 1.385, tauLoop = 16.73) annotation(
        Placement(visible = true, transformation(origin = {-707, -17}, extent = {{-399, -399}, {399, 399}}, rotation = 0)));
    equation
      connect(nineRcore.decayHeat_Out, dhrs.DHRS_DecayHeat) annotation(
        Line(points = {{-966, 274}, {-980, 274}, {-980, 846}, {456, 846}, {456, 570}}, color = {0, 225, 255}));
      connect(nineRcore.decayHeat_Out, pipe.PiDecay_Heat) annotation(
        Line(points = {{-966, 274}, {-938, 274}, {-938, 648}, {294, 648}, {294, -68}, {908, -68}, {908, -448}}, color = {0, 225, 255}));
      connect(nineRcore.decayHeat_Out, PHX.P_decay) annotation(
        Line(points = {{-966, 274}, {-966, 1150}, {1810, 1150}, {1810, 894}}, color = {0, 225, 255}));
      connect(pipe.PiTemp_Out, nineRcore.temp_In) annotation(
        Line(points = {{542, -612}, {-436, -612}, {-436, -312}}));
      connect(nineRcore.temp_Out, dhrs.DHRS_tempIN) annotation(
        Line(points = {{-448, 274}, {-458, 274}, {-458, 458}, {456, 458}}));
      connect(dhrs.DHRS_TempOUT, PHX.T_in_pFluid) annotation(
        Line(points = {{766, 458}, {980, 458}, {980, 810}, {1256, 810}}));
      connect(PHX.T_out_pFluid, pipe.PiTemp_IN) annotation(
        Line(points = {{2382, 810}, {2938, 810}, {2938, -720}, {1208, -720}, {1208, -612}, {908, -612}}));
      connect(uhx.UHXtemp_In, PHX.T_out_sFluid) annotation(
        Line(points = {{2044, -220}, {1264, -220}, {1264, 552}}));
      connect(PHX.T_in_sFluid, uhx.UHXtemp_Out) annotation(
        Line(points = {{2382, 544}, {2796, 544}, {2796, -220}, {2588, -220}}));
      connect(primaryPump.primaryFlowFrac, pipe.fuelFlowFrac) annotation(
        Line(points = {{-626, -1506}, {328, -1506}, {328, -942}, {908, -942}, {908, -795}}, color = {245, 121, 0}));
      connect(primaryPump.primaryFlowFrac, dhrs.fuelFlowFrac) annotation(
        Line(points = {{-626, -1506}, {68, -1506}, {68, 332}, {456, 332}}, color = {245, 121, 0}));
      connect(primaryPump.primaryFlowFrac, PHX.primaryFF) annotation(
        Line(points = {{-626, -1506}, {38, -1506}, {38, 1044}, {1392, 1044}, {1392, 894}}, color = {245, 121, 0}));
      ...
      connect(secondaryPump.secondaryFlowFrac, uhx.secondaryFlowFrac) annotation(
        Line(points = {{1204, -1618}, {1764, -1618}, {1764, -458}, {2044, -458}}, color = {245, 121, 0}));
      connect(primaryPump.primaryFlowFrac, nineRcore.flowFraction_In) annotation(
        Line(points = {{-626, -1506}, {-1464, -1506}, {-1464, -320}, {-978, -320}}, color = {245, 121, 0}));
      annotation(
        Diagram(coordinateSystem(extent = {{-1480, 1160}, {3040, -1780}})));
    end U235_9R_MSRE_8MW;
  end U235_9R;
end U235stepBenchmark;