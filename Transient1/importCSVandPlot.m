...
Results = readmatrix('step100pcmUHX.csv');
...
box on 
hold on
plot(tout-zeroStamp,(Temp_mux(:,1) + Temp_mux(:,2)),'color','#ff0000','LineWidth',1)
plot(Results(:,1)-zeroStamp,Results(:,2),'color','#0000ff','LineWidth',1)
...
box on 
hold on
plot(tout-zeroStamp,Temp_mux(:,1),'color','#ff0000','LineWidth',1)
plot(Results(:,1)-zeroStamp,Results(:,3),'color','#0000ff','LineWidth',1)
...
box on 
hold on
plot(tout-zeroStamp,Temp_mux(:,2),'color','#ff0000','LineWidth',1)
plot(Results(:,1)-zeroStamp,Results(:,4),'color','#0000ff','LineWidth',1)
...
saveas(gcf,'powerUHX100pcm.png')
savefig('powerUHX100pcm.fig')
...
box on 
hold on
plot(tout-zeroStamp,Temp_mux(:,6),'color','#ff0000','LineWidth',1)
plot(Results(:,1)-zeroStamp,Results(:,6),'color','#0000ff','LineWidth',1)
...
box on 
hold on
plot(tout-zeroStamp,Temp_mux(:,3),'color','#ff0000','LineWidth',1)
plot(Results(:,1)-zeroStamp,Results(:,5),'color','#0000ff','LineWidth',1)
...
box on 
hold on
plot(tout-zeroStamp,Temp_mux(:,4),'color','#ff0000','LineWidth',1)
plot(Results(:,1)-zeroStamp,Results(:,7),'color','#0000ff','LineWidth',1)
...
% Save plot as fig and png
saveas(gcf,'tempsUHX100pcm.png')
savefig('tempsUHX100pcm.fig')
...
box on 
hold on
plot(tout-zeroStamp,rho_fb_tot*1E5,'color','#ff0000','LineWidth',1)
plot(Results(:,1)-zeroStamp,(Results(:,8)+Results(:,9)+Results(:,10))*1E5,'color','#0000ff','LineWidth',1)
...
box on 
hold on
plot(tout-zeroStamp,rho_fb_f*1E5,'color','#ff0000','LineWidth',1)
plot(Results(:,1)-zeroStamp,(Results(:,8)+Results(:,9))*1E5,'color','#0000ff','LineWidth',1)
...
box on 
hold on
plot(tout-zeroStamp,rho_fb_g*1E5,'color','#ff0000','LineWidth',1)
plot(Results(:,1)-zeroStamp,(Results(:,10))*1E5,'color','#0000ff','LineWidth',1)
...
% Save plot as fig and png
saveas(gcf,'reactUHX100pcm.png')
savefig('reactUHX100pcm.fig')
