...
%%Load Results 1MW
Results = readmatrix('U233step1MW.csv');
load('U233step1MW.mat')
...
%%Load Results 5MW
Results = readmatrix('U233step5MW.csv');
load('U233step5MW.mat')
...
%%Load Results
Results = readmatrix('U233step8MW.csv');
load('U233step8MW.mat')
...
plot(timeSlink-zeroStamp,(powerSlink-powerSlinkSS)*P,'color','#ff0000','LineWidth',2)
plot(timeModelica-zeroStamp,(Results(:,2)-powerModSS)*P,'--','color','#0000ff','LineWidth',2)
title('+10[pcm] step insertion @ 8MW MSRE-U233')
ylabel('\Delta Power [MW]')
xlabel('[s]')
legend('Simulink', 'Modelica')
xlim([start_plot plot_width]) 
...
saveas(gcf,'U233stepBenchmark.png')
savefig('U233stepBenchmark.fig')