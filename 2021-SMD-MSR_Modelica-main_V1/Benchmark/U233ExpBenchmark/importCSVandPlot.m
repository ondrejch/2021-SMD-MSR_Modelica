...
%%Load Results 1MW
Results = readmatrix('U233Exp1MW.csv');
load('U233Exp1MW.mat')
load('U233EXP1MW.mat')
...
box on 
hold on
plot(x,y,'color','#000000','LineWidth',1)
...
title('+13.9[pcm] step insertion @ 1MW MSRE-U233')
ylabel('\Delta Power [MW]')
legend('Experiment','Simulink','Modelica')
xlim([start_plot plot_width]) 

%%Load Results 5MW
Results = readmatrix('U233Exp5MW.csv');
load('U233Exp5MW.mat')
load('U233EXP5MW.mat')
...
plot(timeSlink-zeroStamp,(powerSlink-powerSlinkSS)*P,'color','#ff0000','LineWidth',2)
plot(timeModelica-zeroStamp,(Results(:,2)-powerModSS)*P,'--','color','#0000ff','LineWidth',2)
title('+19.6[pcm] step insertion @ 5MW MSRE-U233')
ylabel('\Delta Power [MW]')
legend('Experiment','Simulink','Modelica')
xlim([start_plot plot_width])  

%%Load Results
Results = readmatrix('U233Exp8MW.csv');
load('U233Exp8MW.mat')
load('U233EXP8MW.mat')
...
plot(timeSlink-zeroStamp,(powerSlink-powerSlinkSS)*P,'color','#ff0000','LineWidth',2)
plot(timeModelica-zeroStamp,(Results(:,2)-powerModSS)*P,'--','color','#0000ff','LineWidth',2)
title('+14.8[pcm] step insertion @ 8MW MSRE-U233')
ylabel('\Delta Power [MW]')
xlabel('[s]')
legend('Experiment','Simulink','Modelica')
xlim([start_plot plot_width]) 
...
saveas(gcf,'U233Exp1MW.png')
savefig('U233Exp1MW.fig')
...
% 
% % Save plot as fig and png
% saveas(gcf,'tempsTransient3.png')
% savefig('tempsTransient3.fig')
% 
...
% 
% % Save plot as fig and png
% saveas(gcf,'reactTransient3.png')
% savefig('reactTransient3.fig')
