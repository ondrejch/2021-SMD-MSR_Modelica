...
Results = readmatrix('Transient2UHX.csv');
...
saveas(gcf,'powerTransient2UHX.png')
savefig('powerTransient2UHX.fig')
...
% Save plot as fig and png
saveas(gcf,'tempsTransient2UHX.png')
savefig('tempsTransient2UHX.fig')
...
% Save plot as fig and png
saveas(gcf,'reactTransient2UHX.png')
savefig('reactTransient2UHX.fig')
